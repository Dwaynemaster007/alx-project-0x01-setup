...
const UserModal: React.FC<UserModalProps> = ({ onClose, onSubmit }) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    if (name.includes('address.')) {
      ...
      setUser((prevUser) => ({
        ...prevUser,
        address: { ...prevUser.address, geo: { ...prevUser.address.geo, [geoField]: value } }
      }));
    } else {
    ...
    <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
      <div className="bg-white rounded-lg p-8 shadow-lg w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="address.geo.lat" className="block text-gray-700 font-medium mb-2">Latitude</label>
            <input
              type="text"
              id="address.geo.lat"
          ...
          <div className="mb-4">
            <label htmlFor="address.geo.lng" className="block text-gray-700 font-medium mb-2">Longitude</label>
            <input
              type="text"
              id="address.geo.lng"
          ...
          <div className="mb-4">
            <label htmlFor="company.bs" className="block text-gray-700 font-medium mb-2">Company BS</label>
            <input
              type="text"
              id="company.bs"
              name="company.bs"
